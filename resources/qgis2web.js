...
map.getView().fit([13753949.076365, 826161.572299, 13964304.538239, 1035112.684380], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Spatial Distribution of Pump and Engine Set and Small Water Impounding Project (SWIP) Sites of DA Regional Field Office X in Support of the El Niño Response</h2>';
        return titleElement;
    })(),
